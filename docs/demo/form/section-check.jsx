        ...
        <Col span={12}>
          <Form ref={this.form} model={form} rules={this.state.rules} labelWidth='80' labelPlacement='right'>
            <FormItem label='名称' field='name'>
              <Input value={form.name} placeholder='请输入名称' onChange={this.handleChange.bind(this, 'name')}/>
            </FormItem>
            <FormItem label='数量' field='count'>
              <Input value={form.count} placeholder='请输入数量' onChange={this.handleChange.bind(this, 'count')}/>
            </FormItem>
