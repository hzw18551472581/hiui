...
| content                                       | 上传按钮文案                                                                                                                                           | string \| ReactNode                                         | -                                                 | 本地上传                                  |
| tips                                          | 上传文件提示文案                                                                                                                     | string                                                      | -                                                 | -                                         |
...
| loading<Badge type='feature' text='2.4.0+' /> | 文件上传按钮是否 loading，为 true 时按钮不可点击。仅在 type='default' 时有效                                                                             | boolean                                                     | true \| false                                     | false                                     |
